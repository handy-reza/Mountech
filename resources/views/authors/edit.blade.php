...
is-invalid @enderror" placeholder="Authors Name" value="{{$author->name}}">
...
is-invalid @enderror" placeholder="Authors Picture" value="{{$author->picture}}">
...
is-invalid @enderror" placeholder="Authors Number" value="{{$author->address}}">
